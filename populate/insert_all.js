...
const ethernetArr = DbData.ethernetArr;
const wifiArr = DbData.wifiArr;
const networkLayerArr = DbData.networkLayerArr;
const appLayerArr = DbData.appLayerArr;
const polygonArr = DbData.polygonArr;
const linkLayerArr = DbData.linkLayerArr;
const deviceArr = DbData.deviceArr;
const configDeviceArr = DbData.configDeviceArr;
const roomArr = DbData.roomArr;
const userArr = DbData.userArr;
...
module.exports = {
    insertData(req, res, next) {
        ...
        executeQuery();
        // ! THE ORDER MATTERS
        allPromises = [...wifiArr, ...ethernetArr, ...networkLayerArr, ...appLayerArr, ...linkLayerArr, ...deviceArr, ...configDeviceArr, ...polygonArr,
            ...roomArr, ...userArr
        ];
